...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $usersAdoptionEvent->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $usersAdoptionEvent->id)]
            )
        ?></li>
...
<div class="usersAdoptionEvents form large-9 medium-8 columns content">
    <?= $this->Form->create($usersAdoptionEvent) ?>
    <fieldset>
        <legend><?= __('Edit Users Adoption Event') ?></legend>
        <?php
