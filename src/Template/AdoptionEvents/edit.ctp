    ...
    <div class="add-view column">
        ...
        <div class="add-cont scroll1" data-ix="page-load-fade-in">
            <div class="add-header">
                <div class="add-field-h1">Edit an adoption event</div>
            </div>
            <?= $this->Form->create($adoptionEvent) ?>
                <div class="add-input-form-wrap w-form">
                    <form class="add-input-form">
                        ...
                        <div class="date-cont">
                            <?php echo $this->Form->month('event_date', array('class' => 'date-month w-select', 'empty' => 'Month', 'required'=>true)); ?>
                            <?php echo $this->Form->day('event_date', array('class' => 'date-day w-select', 'empty' => 'Day', 'required'=>true)); ?>
                            <?php echo $this->Form->year('event_date', array('class' => 'date-year w-select', 'empty' => 'Year', 'required'=>true)); ?>
                       </div>
