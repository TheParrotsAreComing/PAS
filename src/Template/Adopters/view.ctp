              ...
              <div class="profile-content-cont">
                ...
                <div class="profile-field-cont">
                  <div class="profile-field-cont">
                    ...
                    <div class="block profile-field-text"><?= h($adopter->cat_count) ?></div>
                  </div>
                </div>
                <div class="profile-field-cont">
                  <div class="profile-field-cont">
				...
				<div class="profile-field-cont">
                  <div class="profile-field-cont">
                    <div class="profile-field-name">Reason not to Adopt to this Person: </div>
                    <div class="block profile-field-text"><?= h($adopter->dna_reason) ?></div>
                  </div>
                </div>
              </div>
            </div>
