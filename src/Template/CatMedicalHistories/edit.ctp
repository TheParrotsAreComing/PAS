            ...
            <?= $this->Form->create($catMedicalHistory) ?>
                <div class="add-input-form-wrap w-form">
                    <form class="add-input-form">
                        ...
                        <?= $this->Form->input('medOption', ['required'=>true, 'class'=>'w-select', 'label'=>false, 'empty'=>'Select Medical Option', 'value'=>$medOption, 'options'=>['Next Services Due','Spay', 'Neuter', 'FVRCP', 'Deworm', 'Flea', 'Rabies', 'Blood', 'Other', 'Notes']]); ?>
